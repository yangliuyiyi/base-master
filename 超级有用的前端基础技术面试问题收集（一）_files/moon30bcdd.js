...
var r=[];
for(o in m)m.hasOwnProperty(o)&&r.push(o+":"+m[o]);
...
var d,l,u,w,m,_,f,p=/MicroMessenger/i.test(navigator.userAgent),h=window.define,g=0,v=2,y=4,O=9,b=10;
if(window.__initCatch=function(e){
d=e.idkey,l=e.startKey||0,u=e.limit,w=e.badjsId,m=e.reportOpt||"",_=e.extInfo||"";
...
var h=o[f]||{};
if(!(h.offset>u||"number"!=typeof h.offset||h.offset==y&&_&&_.network_rate&&Math.random()>=_.network_rate)){
var g=1/0==u?l:l+h.offset;
a[f]="[moon]"+d+"_"+g+";"+h.log+";"+n(h.e||{})||"",s[f]=g,c[f]=1;
}
}
for(var v=0;v<s.length;v++)m[v]=d+"_"+s[v]+"_"+c[v],r=r+"&log"+v+"="+a[v];
if(m.length>0&&(i("POST",location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?","idkey="+m.join(";")+"&lc="+a.length+r),
w)){
var O=new Image,b="https://badjs.weixinbridge.com/badjs?id="+w+"&level=4&from="+encodeURIComponent(location.host)+"&msg="+encodeURIComponent(r);
O.src=b.slice(0,1024);
}
}
...
var i=e.localStorage,a=document.head||document.getElementsByTagName("head")[0],s=1,c=2,d=0,l={
prefix:"__MOON__",
loaded:[],
unload:[],
clearSample:Math.random()<d,
hit_num:0,
mod_num:0,
version:1003,
init:function(){
...
var d=1*i.getItem(l.prefix+"clean_time"),u=+new Date;
if(u-d>=1296e6){
l.clear();
try{
...
if(n=l.prefix+s,a=!!r&&r.replace(/^http(s)?:\/\/res.wx.qq.com/,""),o=!!i&&i.getItem(n),
version=!!i&&(i.getItem(n+"_ver")||"").replace(/^http(s)?:\/\/res.wx.qq.com/,""),
l.mod_num++,l.clearSample||!o||a!=version)l.unload.push(a.replace(/^http(s)?:\/\/res.wx.qq.com/,""));else{
...
try{
var d="//# sourceURL="+s+"\n//@ sourceURL="+s;
e.eval.call(e,'define("'+s+'",[],'+o+")"+d),l.hit_num++;
}catch(c){
...
var o,t,n="",r=[],i={},a=-1!=location.search.indexOf("no_moon2=1"),s="//res.wx.qq.com";
-1!=location.href.indexOf("moon_debug2=1")&&(s="//mp.weixin.qq.com");
for(var c=0,d=e.length;d>c;++c)/^\/(.*?)\//.test(e[c]),RegExp.$1&&(t=RegExp.$1,n=i[t],
n?(o=n+","+e[c],o.length>1e3||a?(r.push(n+"?v="+l.version),n=location.protocol+s+e[c],
i[t]=n):(n=o,i[t]=n)):(n=location.protocol+s+e[c],i[t]=n));
for(var u in i)i.hasOwnProperty(u)&&r.push(i[u]);
return r;
},
load:function(e){
if(window.__wxgspeeds&&(window.__wxgspeeds.mod_num=l.mod_num,window.__wxgspeeds.hit_num=l.hit_num),
!e||e.length<=0)return seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),void(console.debug&&console.debug("[moon] load js complete, all in cache, cost time : 0ms, total count : "+l.mod_num+", hit num: "+l.hit_num));
...
seajs.run(),console.debug&&console.debug("[moon] load js complete, url num : "+e.length+", total mod count : "+l.mod_num+", hit num: "+l.hit_num+", use time : "+n+"ms");
}
});
});
},
...
if(o(r,"status","error"),o(r,"end",+new Date),t>=0)l.request(e,t,n);else if(window.__moon_report){
var a=new Error(i);
...
clear:function(){
i&&(r(i,function(e,o){
~o.indexOf(l.prefix)&&i.removeItem(o);
